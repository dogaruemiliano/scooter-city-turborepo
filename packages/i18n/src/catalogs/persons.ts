export const personsCatalog = {
  en: {
    ...
    documentForm: {
      ...
      identityCardHint: "Turn the card, not your phone",
      identityCardDescription:
        "Keep your phone upright. Turn the identity card 90 degrees and fit all its edges inside the outline.",
      identityCardLandscapeDescription:
        "Align the identity card horizontally inside the outline, keeping all edges visible.",
    ...
    placeholders: {
      ...
      localityCountyFirst: "Select county first",
  ...
  ro: {
    ...
    documentForm: {
      ...
      choosePhoto: "Alege din galerie sau fișiere",
      switchCamera: "Schimbă camera",
      processingPhoto: "Se procesează…",
      resetCrop: "Resetează decupajul",
      ...
      identityCardHint: "Rotește actul, nu telefonul",
      identityCardDescription:
        "Păstrează telefonul vertical. Rotește actul de identitate cu 90 de grade și încadrează toate marginile în contur.",
      identityCardLandscapeDescription:
        "Aliniază actul de identitate orizontal în contur, cu toate marginile vizibile.",
      ...
      missingValue: "Necompletat",
      checkDate: "Verifică data",
      expiresShort: "Exp.",
    ...
    placeholders: {
      ...
      localityCountyFirst: "Selectează mai întâi județul",
