...
export const AuditEventType = {
  ...
  MONEY_TRANSACTION_CREATED: "MONEY_TRANSACTION_CREATED",
  MONEY_TRANSACTION_POSTED: "MONEY_TRANSACTION_POSTED",
  MONEY_TRANSACTION_REVERSED: "MONEY_TRANSACTION_REVERSED",
} as const;
